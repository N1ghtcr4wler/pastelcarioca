  ...
  return <section id="coxinha" className="py-16 subtle-texture">
      <div className="container max-w-4xl">
        ...
        <p className="text-xl text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
          La coxinha [Co-shi-ña] es un salgadinho brasileño icónico: una croqueta en forma de colombina de pollo, con masa ligera y crujiente, rellena de pollo desmenuzado sazonado.
        </p>
