...
const varieties = [
  { name: "Coxinha Clásica de Pollo", description: "Relleno de pollo desmenuzado sazonado con especias brasileñas", price: "5.000 COP" },
  { name: "Coxinha de Queso", description: "Relleno cremoso de queso derretido para los amantes del queso", price: "5.500 COP" },
  { name: "Coxinha Vegetariana", description: "Relleno de vegetales y queso, perfecta para vegetarianos", price: "5.000 COP" },
];

const CoxinhaDetailsSection = () => {
  return (
    <section id="coxinha" className="py-16 subtle-texture">
      <div className="container max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none mb-12">
          ...
          <p className="text-muted-foreground mb-4">
            La <strong>coxinha brasileña</strong> es mucho más que un simple pasabocas. Es una experiencia culinaria que combina tradición, sabor y textura en cada bocado. 
        ...
        <div className="mb-12">
          ...
          <div className="aspect-video rounded-lg overflow-hidden bg-muted">
            <iframe
              ...
              title="Cómo se hace una coxinha en Pastel Carioca"
              frameBorder="0"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="rounded-lg overflow-hidden">
              <img 
                ...
                alt="Coxinha de pollo clásica en Bogotá - dorada y crujiente"
            ...
            <div className="rounded-lg overflow-hidden">
              <img 
                src="/lovable-uploads/c494832f-4efe-4520-8cf3-b25bbe1813fe.png" 
                alt="Coxinha de queso derretido para eventos Bogotá"
                className="w-full h-64 object-cover hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
            </div>
            <div className="rounded-lg overflow-hidden">
              <img 
                src="/lovable-uploads/9d23cdb3-0a9f-4a98-aa17-69eef09f7c25.png" 
                alt="Mini coxinha vegetariana para catering corporativo Bogotá"
                className="w-full h-64 object-cover hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
            </div>
            <div className="rounded-lg overflow-hidden">
              <img 
                src="/lovable-uploads/d11d43e2-fb65-46d9-9217-db466fb3b4b0.png" 
                alt="Pack de coxinhas brasileñas para fiestas en Bogotá"
                className="w-full h-64 object-cover hover:scale-105 transition-transform duration-300"
                loading="lazy"
              />
            </div>
